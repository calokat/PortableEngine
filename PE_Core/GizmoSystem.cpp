...
void GizmoSystem::DrawGizmo(Camera camera, entt::basic_view<entt::entity, entt::get_t<Transform>, entt::exclude_t<>, void> transformView, const GameWindow& gameWindow)
{
	if (selected.empty())
	{
		return;
