...
using namespace std;
//void Mesh::CreateBuffers(Vertex* vertices, int numVertices, unsigned int* indices, int numIndicesParam, Microsoft::WRL::ComPtr<ID3D11Device> device)
//{
//	this->numIndices = numIndicesParam;
//
...
//	ibd.ByteWidth = sizeof(int) * this->numIndices;         // 3 = number of indices in the buffer
...
//Mesh::Mesh(Vertex* vertices, int numVertices, unsigned int* indices, int numIndicesParam, Microsoft::WRL::ComPtr<ID3D11Device> device)
//{
//	this->numIndices = numIndicesParam;
//
//	D3D11_BUFFER_DESC vbd;
...
//	CalculateTangents(&verts[0], vertCounter, &indices[0], indices.size());
//	CreateBuffers(&verts[0], vertCounter, &indices[0], indices.size(), device);
//	rawVertices = verts;
//	rawIndices = indices;
//}
